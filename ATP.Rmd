...
atp %>%
  ...
  theme(strip.text = element_text(size = rel(1)),
        axis.text.x = element_text(angle = 90, size = rel(.7), hjust = 1))
...
atp %>%
  ...
  theme_ipsum(grid = "y") +
  theme(strip.text = element_text(size = rel(1)),
        axis.text.x = element_text(angle = 90, size = rel(.9), hjust = 1))
...
atp %>%
  ...
  labs(title = "ATP Episodes", subtitle = "Episode per Month", 
       x = "", y = "# of Episodes", caption = caption) +
  theme(strip.text = element_text(size = rel(1)),
        axis.text.x = element_text(angle = 90, size = rel(.9), hjust = 1),
