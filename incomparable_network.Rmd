...
incomparable_master_wide %>%
  ...
  labs(x = "", y = "First to Last Episode Date",
       title = "The Incomparable Network", subtitle = "Show Timelines",
       caption = caption)
```
...
In 2017, *The Incomparable* published `r as.character(dminutes(sum(incomparable_master_wide$duration[incomparable_master_wide$year == "2017"])))` of content. That's a lot. In case you were wondering what time is.
