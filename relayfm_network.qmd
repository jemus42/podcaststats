...
```{r}
#| results: asis
glue::glue("[Relay FM](https://relay.fm/) spans **{length(shows)}** shows and a combined runtime of over **{round(sum(relay_episodes$duration, na.rm = TRUE)/ddays(1))}** days spread across **{nrow(relay_episodes)}** episodes since 2014.
