...
ggplot(people_activity, aes(x = reorder(people, duration_per_week), y = duration_per_week)) +
  ...
  coord_flip() +
  labs(title = "Relay.fm",
       subtitle = "Total duration per host divided by number of weeks active (first to latest appearance)",
...
ggplot(people_activity) +
  ...
  coord_flip() +
    labs(title = "Relay.fm",
       subtitle = "Period of hosting activity (first to most recent show), ordered by first appearance",
       x = "", y = "Date of show",
       caption = caption)
```
